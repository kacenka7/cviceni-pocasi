...
console.log(pocasiId)

const pocasi = predpoved.find((item)=> item.id === pocasiId)
...
console.log(pocasi)
    ...
    <div class="article-card">
      <h2>${pocasi.den}</h2>
      <p>Datum: ${pocasi.datum}</p>
      <p>${pocasi.stav_pocasi}</p> 
      <p>Denní teplota: ${pocasi.denni_teplota}</p>
      <p>Ranní teplota: ${pocasi.ranni_teplota}</p>
      <p>Odpolední teplota: ${pocasi.odpoledni_teplota}</p>
      <p>Večerní teplota: ${pocasi.vecerni_teplota}</p>
